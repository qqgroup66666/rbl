...
def resnet20(num_classes=10, use_norm=False):
    return ResNet_s(BasicBlock, [3, 3, 3], num_experts=3, num_classes=num_classes, use_norm=use_norm)


def resnet32(num_experts, num_classes, use_norm=False):
    return ResNet_s(BasicBlock, [5, 5, 5], num_experts=num_experts, num_classes=num_classes, use_norm=use_norm)
