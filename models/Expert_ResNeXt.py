...
def resnext50(num_classes, reduce_dimension=True, layer3_output_dim=None, layer4_output_dim=None):
    return ResNext(Bottleneck, [3, 4, 6, 3], groups=32, width_per_group=4, dropout=None, num_classes=num_classes, use_norm=True,
        reduce_dimension=reduce_dimension, layer3_output_dim=layer3_output_dim, layer4_output_dim=layer4_output_dim, num_experts=1)
